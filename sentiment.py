...
model = joblib.load(r"C:/Users/LENOVO/RFC.pkl")
vectorizer = joblib.load(r"C:/Users/LENOVO/tfidf.pkl")
...
def app():
    ...
    st.write('Enter a sentence and we will predict its sentiment')
